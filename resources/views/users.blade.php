                    ...
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Cognoms</th>
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?= $user->cognoms; ?></td>
